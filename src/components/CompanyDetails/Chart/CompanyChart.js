...
class ApexChart extends React.Component {
  ...
  getData = () => {
    ...
    const API = axios.create({
      baseURL: "https://www.alphavantage.co/query?function=TIME_SERIES_"+this.state.timeSeries+"&symbol="+this.props.companyCode+"&apikey="+process.env.REACT_APP_ALPHAVANTAGE,
    });
    API.get("/").then(result => {
